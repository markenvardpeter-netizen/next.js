...
async function stagedRenderToReadableStreamWithoutCachesInDev(
  ...
  const environmentName = () => {
    ...
    switch (currentStage) {
      ...
      case RenderStage.RuntimeInterrupted:
    ...
    () =>
      pipelineInSequentialTasks(
        ...
        async (stream) => {
          ...
          if (stream === null) {
            // we already abandoned this render
            return null
          }
...
async function spawnStaticShellValidationInDev(
  ...
  console.log('WAITING 2 SECONDS', { debugChannelClient })
  ...
  if (staticInterruptReason) {
    resolveValidation(
      createElement(LogSafely, {
        fn: () => {
          console.error(staticInterruptReason)
        },
      })
    )
    return
  ...
  if (runtimeInterruptReason) {
    resolveValidation(
      createElement(LogSafely, {
        fn: () => {
          console.error(runtimeInterruptReason)
        },
      })
    )
    return
  ...
  resolveValidation(runtimeResult)
  return
}
...
async function validateStagedShell(
  ...
  try {
    ...
    return createElement(LogSafely, {
